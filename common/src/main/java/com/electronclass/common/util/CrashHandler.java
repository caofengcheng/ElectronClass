...
import com.electronclass.common.database.Constants;
        ...
        new Thread() {
            ...
            public void run() {
                ...
                Toast.makeText(mContext, "很抱歉,程序出现异常,正在收集日志，即将退出", Toast.LENGTH_LONG)
                        .show();
                try {
                    Intent intent = new Intent(mContext, Class.forName(GlobalPage.LoginActivity));
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(
                ...
                String path = FileUtil.getAppSDMainPath() + Constants.DIR_CRASH;
