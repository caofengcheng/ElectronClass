...
public class DailogUtil {
    ...
    public DailogUtil(Context context) {
        this(context, R.style.CustomDialog);
    }

    public DailogUtil(Context context, int themeResId) {
    ...
    //自定义layout用这个
    public DailogUtil(Context context, int themeResId, View layout) {
    ...
    //能否返回键取消
    public DailogUtil setCancelable(Boolean cancelable) {
        this.cancelable = cancelable;
        return this;
    }

    public DailogUtil title(CharSequence title) {
        this.title = title;
        return this;
    }

    public DailogUtil message(CharSequence message) {
        this.message = message;
        return this;
    }

    public DailogUtil cancelText(CharSequence str) {
        this.cancelText = str;
        return this;
    }

    //确定按钮文本
    public DailogUtil sureText(CharSequence str) {
        this.sureText = str;
        return this;
    }

    public DailogUtil setSureOnClickListener(View.OnClickListener listener) {
        this.sureClickListener = listener;
        return this;
    }

    public DailogUtil setCancelOnClickListener(View.OnClickListener listener) {
